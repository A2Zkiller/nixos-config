{
  settings = {
    ...
    wallpaper = {
      ...
      directory = "/home/a2z/Pictures/Wallpapers";
  ...
  state = {
    barVisible = true;
    changelogState = {lastSeenVersion = "v4.7.7";};
    colorSchemesList = {
      schemes = [];
      timestamp = 0;
    };
    ...
    wallpapers = {Virtual-1 = "/nix/store/wp0kv9bbq8w0k4pzbr7g9yy52nbhfm6c-noctalia-shell-4.7.7/share/noctalia-shell/Assets/Wallpaper/noctalia.png";};
  };
}
